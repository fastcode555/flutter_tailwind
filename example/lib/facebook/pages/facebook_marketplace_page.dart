...
class FacebookMarketplacePage extends StatelessWidget {
      ...
      body: column.children([
        ...
        container.h100.white.child(
          ListView(
            ...
            children: [
              _buildCategoryItem(Icons.car_rental, '汽车'),
              _buildCategoryItem(Icons.house, '房产'),
              _buildCategoryItem(Icons.phone_android, '电子产品'),
              _buildCategoryItem(Icons.chair, '家具'),
              _buildCategoryItem(Icons.shopping_bag, '服饰'),
            ],
          ),
        ),
        // 商品列表
  ...
  Widget _buildCategoryItem(IconData icon, String label) {
    return container.w80.mr8.child(
