...
abstract class _BaseCheckBoxBuilder extends CallBackBuilder<bool>
    with
        ColorBuilder,
        BorderColorBuilder,
        SizeBuilder,
  ...
  double get _ratio => ratio ?? (_systemStyle ? 0.7 : 0.75);
...
extension CheckBoxMixinExt<T extends CheckBoxMixin> on T {
  ...
  T get systemStyle => this.._systemStyle = true;
}
