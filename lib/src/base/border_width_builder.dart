...
extension BorderWidthBuilderExt<T extends BorderWidthBuilder> on T {
  ...
  ///border width 1
  T get border1 => this..innerBorderWidth = 1;

  ///border width 2
  T get border2 => this..innerBorderWidth = 2;

  ///border width 3
  T get border3 => this..innerBorderWidth = 3;

  ///border width 4
  T get border4 => this..innerBorderWidth = 4;

  ///border width 5
  T get border5 => this..innerBorderWidth = 5;

  ///border width 6
  T get border6 => this..innerBorderWidth = 6;

  ///border width 7
  T get border7 => this..innerBorderWidth = 7;

  ///border width 8
  T get border8 => this..innerBorderWidth = 8;

  ///border width 9
  T get border9 => this..innerBorderWidth = 9;

  ///border width 10
  T get border10 => this..innerBorderWidth = 10;

  ///border width 12
  T get border12 => this..innerBorderWidth = 12;

  ///border width 14
  T get border14 => this..innerBorderWidth = 14;

  ///border width 16
  T get border16 => this..innerBorderWidth = 16;

  ///border width 18
  T get border18 => this..innerBorderWidth = 18;

  ///border width 20
  T get border20 => this..innerBorderWidth = 20;

  ///border width 22
  T get border22 => this..innerBorderWidth = 22;

  ///border width 24
  T get border24 => this..innerBorderWidth = 24;

  ///border width 26
  T get border26 => this..innerBorderWidth = 26;

  ///border width 28
  T get border28 => this..innerBorderWidth = 28;

  ///border width 30
  T get border30 => this..innerBorderWidth = 30;

  ///border width 32
  T get border32 => this..innerBorderWidth = 32;

  ///border width 34
  T get border34 => this..innerBorderWidth = 34;

  ///border width 36
  T get border36 => this..innerBorderWidth = 36;

  ///border width 38
  T get border38 => this..innerBorderWidth = 38;

  ///border width 40
  T get border40 => this..innerBorderWidth = 40;

  ///border width 42
  T get border42 => this..innerBorderWidth = 42;

  ///border width 44
  T get border44 => this..innerBorderWidth = 44;

  ///border width 46
  T get border46 => this..innerBorderWidth = 46;

  ///border width 48
  T get border48 => this..innerBorderWidth = 48;

  ///border width 50
  T get border50 => this..innerBorderWidth = 50;
